...
const ComponentSegment = ({
	...
	<div className=" flex flex-col gap-5">
		<div className="  w-full">
			...
			<div className=" flex w-full gap-10 justify-around">{children}</div>
		</div>
	</div>
);
	...
	return (
		<main className=" p-2">
			...
			<ComponentSegment component="Button">
				<Button type="button" size="sm" onClick={TestClick}>
					Button
				</Button>
				<Button type="radio" value="radio" setValue={TestClick}>
					Radio
				</Button>
				<Button type="menu" onClick={TestClick}>
					Menu
				</Button>
			</ComponentSegment>
			<ComponentSegment component="Searchbar">
				<SearchBar placeholder="Search" />
				<SearchBar small placeholder="Search" />
			</ComponentSegment>
